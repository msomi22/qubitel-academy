...
test('CBC Grade 1 exposes matching subject learning areas with content under the right subjects', () => {
  ...
  assert.deepEqual(english.assessments.map((item) => item.id), ['writing-missing-letters-exam-001', 'object-matching-exam-001', 'greetings-exam-001', 'reading-word-mastery-exam-002', 'reading-word-mastery-exam-003', 'reading-word-mastery-exam-004', 'reading-word-mastery-exam-005', 'reading-word-mastery-exam-006']);
