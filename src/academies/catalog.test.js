...
test('CBC Grade 1 declares the shared subject structure with content under learning areas', () => {
  ...
  assert.deepEqual(english.assessments.map((item) => item.id), ['object-matching-exam-001', 'reading-word-mastery-exam-002', 'reading-word-mastery-exam-003', 'reading-word-mastery-exam-004', 'reading-word-mastery-exam-005']);
